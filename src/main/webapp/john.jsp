...
<div class="wrapper">
    <header class="header">
        <div class="header__container">
            <a href="/application#about" class="header__logo">
            ...
            <div class="header__button">
                <a href="/application#about" class="button btn">Back</a>
            </div>
        </div>
    </header>
    <main class="main">
            ...
            <div class="doctor__container">
                ...
                <div class="text-container">
                    ...
                    <div class="info-container">
                        <div class="info">
                            John Dou loves working as a veterinarian as it allows him to give back to the most vulnerable
                            of our population, our pets! He is an advocate of preventive health care and has a special
                            interest in veterinary dentistry. When away from the clinic,
                            he enjoys time with his family, working on art projects, and participating in endurance races.
                        </div>
                    </div>
                </div>
            </div>
