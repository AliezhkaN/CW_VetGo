        ...
        <section class="doctors">
            <div class="doctor__container">
                <div class="image-container">
                    <img src="images/services02.jpg" alt="jane">
                </div>
                <div class="text-container">
                    <div class="title">
                        <span>Animal Dental Care</span>
                    </div>
                    <div class="info-container">
                        <div class="info">
                            Many people are surprised to hear that the specialty of veterinary dentistry and oral
                            surgery exists. They’ve simply never considered that
                            pets need dental care or oral surgery. In many ways, the field is similar
                            to human dentistry and oral surgery
                        </div>
                    </div>
                </div>
            </div>
