        ...
        <section class="doctors">
            <div class="doctor__container">
                <div class="image-container">
                    <img src="images/services03.jpg" alt="jane">
                </div>
                <div class="text-container">
                    ...
                    <div class="info-container">
                        <div class="info">
                            We perform elective surgeries when your pet is considered generally healthy,
                            which reduces complications. That said, even urgent care pet surgery has become significantly lower risk
                            today due to improvements in modern veterinary medicine and changes in standards of veterinary care.
                        </div>
                    </div>
                </div>
            </div>
