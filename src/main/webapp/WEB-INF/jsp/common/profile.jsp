...
<html>
<head>
    <title>VetGo - Profile</title>
    <style>
        <%@include file="/styles/common/default.css" %>
        <%@include file="/styles/profile/profile.css" %>
    ...
    <header class="header">
        <div class="header__container">
            ...
            <nav class="header__menu menu">
                <ul class="menu__list">
                    <li class="menu__item"><a href="/application" class="menu__link">HOME</a></li>
                    <c:choose>
                    ...
                    <li class="menu__item"><a href="profile" class="menu__link">PROFILE</a></li>
                </ul>
            </nav>
            ...
            <div class="profile__info-container">
                <div class="profile__title-container">
                    ...
                    <div id="email-p" class="profile__email">
                        <div class="name__name">Email</div>
                    ...
                    <form id="email-i" class="profile__email hide" action="changeEmail" method="post">
                        ...
                        <div class="name__value__edit">
                            ...
                            <div>
                                <input id="new_email" required placeholder="New email address" name="newEmail" type="email" class="input black">
                            </div>
                            <div id="confirm_new_email_label" class="hide">
                                <label for="confirm_new_email">Confirm new email address</label>
                            </div>
                            <div>
                                <input id="confirm_new_email" required placeholder="Confirm new email" name="confirmNewEmail" type="email" class="input black">
                            </div>
                            <div id="confirm_password_label" class="hide">
                                <label for="confirm_password">Confirm password</label>
                            </div>
                            <div>
                                <input id="confirm_password" required placeholder="Confirm password" name="confirmPassword" type="password" class="input black">
                            </div>
                            <div class="buttons_container">
                                <div class="buttons">
                                    <input class="button" type="submit" value="Save">
                                    <button id="email_cancel_button" class="button cancel_button">Cancel</button>
                                </div>
                            </div>
                    ...
                    <div id="password-p" class="profile__email">
                        <div class="name__name">Password</div>
                        <div class="name__value">
                            <span>******</span>
                        </div>
                        <div class="name__edit">
                    ...
                    <form id="password-i" class="profile__email hide" action="changePassword" method="post">
                        ...
                        <div class="name__value__edit">
                            ...
                            <div>
                                <input id="current_password" required placeholder="Current password" name="currentPassword" type="password" class="input black">
                            </div>
                            <div id="new_password_label" class="hide">
                                <label for="new_password">New password</label>
                            </div>
                            <div>
                                <input id="new_password" required placeholder="New password" name="newPassword" type="password" class="input black">
                            </div>
                            <div id="confirm_new_password_label" class="hide">
                                <label for="confirm_new_password">Confirm new password</label>
                            </div>
                            <div>
                                <input id="confirm_new_password" required placeholder="Confirm new password" name="confirmNewPassword" type="password" class="input black">
                            </div>
                            <div class="buttons_container">
                                <div class="buttons">
                                    <input class="button" type="submit" value="Save">
                                    <button id="password_cancel_button" class="button cancel_button">Cancel</button>
                                </div>
                            </div>
                            <div class="error__message__wrapper">
                    ...
                    <form id="fullname-i" class="profile__email hide" action="changeFullName" method="post">
                        ...
                        <div class="name__value__edit">
                            ...
                            <div>
                                <input id="first_name" required placeholder="First name"
                                       name="firstName" type="text" class="input black"
                                       value="${user.firstName}">
                            </div>
                            <div id="last_name_label" class="hide">
                                <label for="last_name">Last name</label>
                            </div>
                            <div>
                                <input id="last_name" required placeholder="Last name"
                                       name="lastName" type="text" class="input black"
                                       value="${user.lastName}">
                            </div>
                            <div class="buttons_container">
                                <div class="buttons">
                                    <input class="button" type="submit" value="Save">
                                    <button id="fullname_cancel_button" class="button cancel_button">Cancel</button>
                                </div>
                            </div>
                            <div class="error__message__wrapper">
...
<c:if test="${changeEmailMessage != null}">
    <script>
        ...
        emailI.classList.add('show','fade');
        emailI.classList.remove('hide');

        emailP.classList.add('hide');
        emailP.classList.remove('show','fade');

    </script>
    <% session.removeAttribute("changeEmailMessage");%>
</c:if>
...
<c:if test="${changePasswordMessage != null}">
    <script>
        ...
        passwordI.classList.add('show','fade');
        passwordI.classList.remove('hide');

        passwordP.classList.add('hide');
        passwordP.classList.remove('show','fade');
...
<script type="text/javascript">
    <%@include file="/js/profile/profile.js" %>
</script>
</body>
</html>
