...
<head>
    ...
    <style>
        ...
        <%@include file="/styles/profile/appointment/appointment.css" %>
    ...
    <main class="main">
        <section class="appointment">
                ...
                <c:choose>
                    ...
                    <div class="appointment__container flex-column">
                        ...
                        <div class="text-container">
                            <p>There is not available appointment yet!</p>
                        ...
                        <div class="appointment__container flex-row">
                            ...
                            <div class="inf-container">
                                ...
                                <div class="timer-title">
                                    <span>time left to appointment</span>
                                </div>
                                <div class="clock-container">
                                    <input type="hidden" id="time" value="${appointment.getAppointmentDate()}">
                                    <div class="timer">
                                        <div class="card">
                                            <div class="number">
...
<c:if test="${appointmentError != null}">
    ...
    <% session.removeAttribute("appointmentError");%>
</c:if>
