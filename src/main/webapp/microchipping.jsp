    ...
    <section class="doctors">
      <div class="doctor__container">
        <div class="image-container">
          <img src="images/services01.jpg" alt="jane">
        </div>
        <div class="text-container">
          ...
          <div class="info-container">
            <div class="info">
              The best reason to have your animals microchipped is
              the improved chance that you'll get your animal back if it becomes lost or stolen.
            </div>
          </div>
        </div>
      </div>
